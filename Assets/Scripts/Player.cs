...
public class Player : MonoBehaviour
{
    ...
    private bool playerUnlockedKeyAD = false;
    private bool playerUnlocked => playerUnlockedByGameUI && playerUnlockedKeyAD;
    ...
    void Start()
    {
        ...
        playerUnlockedKeyAD = false;
        playerUnlockedByGameUI = false;
    ...
    {
        float horizontalInput = Input.GetAxisRaw("Horizontal"); // Gets -1 (A), 1 (D), or 0 (no input)
    ...
    private void CheckInput()
    {
        ...
        playerUnlockedKeyAD = Input.GetKey(KeyCode.A) || Input.GetKey(KeyCode.D); // Allow movement when A or D is pressed
    }
    #endregion
    #region Animations
